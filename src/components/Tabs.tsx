...
export function Tab(props: Ariakit.TabProps) {
	return (
		<Ariakit.Tab
			{...props}
			className={twMerge(
				"hover:bg-primary-700 data-active-item:bg-primary-700 flex h-10 flex-1 items-center justify-center gap-3 rounded-md px-4 opacity-50 transition hover:opacity-75 data-active-item:opacity-100 [&>svg]:-mx-1 [&>svg]:size-5",
				props.className,
			)}
		/>
	)
