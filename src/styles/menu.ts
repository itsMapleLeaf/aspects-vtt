...
export const menuItem = (...classes: ClassNameValue[]) =>
	twMerge(
		"flex h-control-md cursor-default items-center justify-start rounded-sm px-control-padding-md text-start hover:bg-primary-600 data-active-item:bg-primary-600",
