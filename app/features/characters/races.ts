...
export const Races: Race[] = [
	{
		...
		abilities: [
			...
			},
			{
				...
				description: `When in the presence of another aquilian,  your Sense rolls have +3 boost dice.`,
			},
		],
	},
	{
	...
	},
	{
		...
		abilities: [
			{
				name: "Right Side Up",
				description: `If you would take damage from a fall, you land perfectly on your feet, then roll your mobility die and reduce that much damage.`,
			},
			{
				name: "Slippery",
				description: `When an enemy becomes adjacent to you, you may roll mobility and move that many meters away from them, then take 1 fatigue.`,
			},
		],
	},
	{
		...
		abilities: [
			{
				...
				description: `You can only use your feet for Strike actions. When you do, double your damage dealt.`,
			},
			{
				name: "Leap of Confidence",
				description: `Leap when using Dash - you are in the air while moving, and you can only move in a straight line.`,
			},
			{
	...
	},
	{
		...
		abilities: [
			...
			},
			{
				...
				description: `When taking damage, roll Strength and subtract that amount to no less than 1.`,
			},
		],
	},
	{
		...
		abilities: [
			...
			{
				name: "Tail Whip",
				description: `Use your tail to knock adjacent characters prone. Until the start of their next turn, their rolls ignore boost dice.`,
			},
		],
	},
	{
	...
	},
	{
		...
		abilities: [
			...
			},
			{
				...
				description: `Always know the presence of other umbraleth within a distance equal to your Sense plus your Wit.`,
			},
		],
	},
]

export const RacesByName: ReadonlyMap<Race["name"], Race> = new Map(
	Races.map((race) => [race.name, race]),
)
