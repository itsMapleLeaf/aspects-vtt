...
export function TokenLabel(props: { text: string; subText?: string }) {
	...
	return (
		<>
			...
			>
				<div className="flex-center whitespace-nowrap rounded bg-black/50 px-2.5 py-1 text-center shadow">
					<p className="text-lg">{props.text}</p>
					<p className="-mt-1 whitespace-pre-line text-base opacity-75 empty:hidden">
						{props.subText}
					</p>
				</div>
			</div>
