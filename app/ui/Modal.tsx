...
export function ModalPanel({
	...
	return (
		<Ariakit.Dialog
			...
			{...props}
			className={panel(
				"fixed inset-0 m-auto flex w-[calc(100%-var(--gutter))] min-w-0 max-w-xl flex-col overflow-clip rounded-md bg-primary-100 shadow-lg shadow-black/50 [--gutter:2rem] [--height:calc(min(100%-var(--gutter),64rem))]",
